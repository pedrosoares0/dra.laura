    ...
    return (
      ...
      >
        ...
        >
          ...
          <div
            className={cn(
              "absolute top-1/2 -translate-y-1/2 -translate-x-1/2 h-10 w-10 flex items-center justify-center rounded-full bg-white/60 text-slate-800 shadow-xl backdrop-blur-md",
          ...
          >
            <div className="flex items-center">
              <ChevronLeft className="h-4 w-4 drop-shadow-md text-slate-800" />
              <ChevronRight className="h-4 w-4 drop-shadow-md text-slate-800" />
            </div>
          </div>
        </div>
      </div>
